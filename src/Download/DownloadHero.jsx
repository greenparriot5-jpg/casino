...
const DOWNLOAD_URL =
  "teenpattigold99.com?from_gameid=8756858&channelCode=100000";
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <a
            ...
            aria-label="Download"
          >
            <div className="relative mx-auto overflow-hidden rounded-2xl border border-gray-300 bg-white p-1.5 shadow-xl shadow-gray-400/30 transition duration-300 hover:-translate-y-1 hover:border-yellow-400">

              <img
                src={IMAGE_URL}
                alt="Three Patti Gold"
                className="block h-[220px] w-[340px] rounded-xl object-cover transition duration-300 hover:scale-[1.02] sm:h-[260px] sm:w-[440px]"
              />
